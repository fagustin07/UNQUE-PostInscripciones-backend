...
internal class ComisionServiceTest {
    ...
    fun setUp() {
        val alumno =
            alumnoService.crear(FormularioCrearAlumno(123312, "", "", "", 1234, Carrera.LICENCIATURA))
        val alumno2 =
            alumnoService.crear(FormularioCrearAlumno(1233123, "", "", "", 12345, Carrera.LICENCIATURA))
