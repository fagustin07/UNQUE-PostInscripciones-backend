...
internal class ComisionServiceTest {
    ...
    fun setUp() {
        ...
        alumnoService.guardarFormulario(alumno.dni, listOf(comision.id!!, comision2.id!!), cuatrimestre)
        alumnoService.guardarFormulario(alumno2.dni, listOf(comision2.id!!), cuatrimestre)
