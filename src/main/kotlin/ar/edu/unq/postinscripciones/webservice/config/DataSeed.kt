...
class DataSeed(
    ...
    private fun loadData() {
        ...
        if (emptyData()) {
            ...
            alumnoService.guardarFormulario(bartolo.dni, listOf(bddc1.id!!, bddc2.id!!),  cuatrimestre)
            alumnoService.guardarFormulario(jorge.dni, listOf(estrc1.id!!), cuatrimestre)
            alumnoService.guardarFormulario(roberto.dni, listOf(introc1.id!!, introc2.id!!), cuatrimestre)
            alumnoService.guardarFormulario(maria.dni, listOf(bddc1.id!!), cuatrimestre)
